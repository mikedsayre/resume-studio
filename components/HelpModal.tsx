        ...
        <div className="text-gray-200 dark:text-gray-700 space-y-4 font-inter">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>
                <strong>Custom CSS Editor:</strong> Click the <code className="font-mono bg-gray-700 dark:bg-gray-300 px-1 rounded text-green-300 dark:text-green-800">{'< />'}</code> icon (part of the Export buttons group) to open a CSS editor. Here, you can write custom CSS to override or add new styles to your resume, giving you ultimate control. Your custom CSS rules will take precedence over the selected style preset. For full control, especially over properties like `font-family` or `color` which might be strongly defined by presets, you may need to add `!important` to your custom CSS declarations.
              </li>
              <li>
